...
const rangeFilesCache = new Map();
const rangeFileMetadataCache = new Map();
...
export function formatErrorDetails(error, context = {}) {
...
export async function getDiffFiles(range, options = {}) {
...
export function rangeFilesCacheKey(range, options = {}) {
    if (range.includesWorktree) {
        return "";
    }
...
export function getCachedRangeFiles(cacheKey) {
...
export function setCachedRangeFiles(cacheKey, files) {
...
export async function getRangeFiles(range, options = {}) {
...
export function cloneReviewKeysByFile(reviewKeysByFile) {
    return Object.fromEntries(Object.entries(reviewKeysByFile));
}
export async function getRangeFileMetadataCacheInfo(range, options = {}) {
    if (range.includesWorktree) {
        return null;
    }
...
export function getCachedRangeFileMetadata(cacheKey) {
...
export function setCachedRangeFileMetadata(cacheKey, metadata) {
...
export async function getRangeFileMetadata(range, options = {}) {
...
export async function getFileDiff(range, file, options = {}) {
    if (!file) {
        return "";
    }
...
async function hashWorktreeFile(hash, kind, file) {
