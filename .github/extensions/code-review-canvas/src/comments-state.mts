...
type LocalCommentInput = {
    ...
    codeLine?: string;
    selectedCode?: string;
    selectionStartLineKey?: string;
    selectionEndLineKey?: string;
    selectionStartLineNumber?: string;
    selectionEndLineNumber?: string;
    selectionStartColumn?: string;
    selectionEndColumn?: string;
    selectionStartLineSide?: string;
    selectionEndLineSide?: string;
    body?: string;
};

let commentsDatabase: DatabaseSync | null = null;
...
function getCommentsDatabase() {
    ...
    `);
    const columns = commentsDatabase.prepare("PRAGMA table_info(local_comments)").all() as Array<{ name: string }>;
...
export function addLocalComment(input: LocalCommentInput) {
    const database = getCommentsDatabase();
    ...
    `).run(
        ...
        comment.selectionStartLineKey,
        comment.selectionEndLineKey,
        comment.selectionStartLineNumber,
        comment.selectionEndLineNumber,
        comment.selectionStartColumn,
        comment.selectionEndColumn,
        comment.selectionStartLineSide,
        comment.selectionEndLineSide,
        comment.body,
        comment.createdAt,
        comment.updatedAt,
        comment.status,
