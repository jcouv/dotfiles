...
type OverviewRequestInput = {
    ...
    entries: { title?: string; subtitle?: string; id?: string; kind?: string }[];
};

type OverviewRequest = OverviewRequestInput & {
    id: string;
    createdAt: string;
    requestPath: string;
    htmlPath: string;
...
function overviewId(input: Pick<OverviewRequestInput, "normalizedBaseline" | "endSha"> & { includesWorktree?: boolean; worktreeFingerprint?: string }) {
...
function buildPrompt(request: OverviewRequestInput, id: string, htmlOutputPath: string) {
...
export function createOverviewRequest(input: OverviewRequestInput) {
...
export function findOverviewRequest(input: Pick<OverviewRequestInput, "workingDirectory" | "normalizedBaseline" | "endSha" | "includesWorktree" | "worktreeFingerprint">) {
    const id = overviewId(input);
