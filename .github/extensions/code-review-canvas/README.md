...
- powerful diff: 
  - reviewers need to be able to look at the entire file, sometimes at other files (not part of the PR), not a few lines around a diff hunk
  - incremental review: I left some comments and a review on commit 5, the tool should remember that and let me see changes from commit 6 onwards
