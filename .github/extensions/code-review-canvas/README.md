...
Here are some the requirements for the basic code review experience:
- robust comment tracking and conventions so that comments don't get lost
  - we need clear workflow and ownership for comments: "active" comments are for the PR owner to address, "resolved" comments are back in the reviewer's camp, and the reviewer is responsible to mark his comments as "closed"
...
- faciliate incremental review: I left some comments and a review on commit 5, the tool should remember that and let me see changes from commit 6 onwards
